...
AutomationTool.exe BuildGraph -target="Make Installed Build Win64" -script=Engine/Build/InstalledEngineBuild.xml -set:WithWin64=true -set:WithMac=false -set:WithAndroid=false -set:WithIOS=false -set:WithTVOS=false -set:WithLinux=true -set:WithLinuxArm64=false -set:WithServer=true -set:WithFullDebugInfo=false -set:GameConfigurations=Shipping;Development;DebugGame -clean
echo.  
